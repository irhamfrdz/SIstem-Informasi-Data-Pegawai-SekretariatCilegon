...
<div class="row">
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-success">
			...
			<a href="index.php?page=data-pns-sek" class="small-box-footer">Informasi
			</a>
		</div>
	</div>
	<!-- ./col -->
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-danger">
			...
			<a href="index.php?page=data-tkk-sek" class="small-box-footer">Informasi
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-secondary">
			...
			<a href="index.php?page=data-thl-sek" class="small-box-footer">Informasi
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-primary">
			...
			<a href="index.php?page=data-ob-sek" class="small-box-footer">Informasi
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-success">
			...
			<a href="index.php?page=data-pamdal-sek" class="small-box-footer">Informasi
			</a>
		</div>
	</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-danger">
			...
			<a href="index.php?page=data-prt-sek" class="small-box-footer">Informasi
			</a>
		</div>
	</div>
