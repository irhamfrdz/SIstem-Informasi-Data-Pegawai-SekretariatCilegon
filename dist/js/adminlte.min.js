...
!(function (t, e) {
  ...
  var e = (function (t) {
        ...
        A = (function () {
          ...
          return (
            ...
            (n._fixScrollHeight = function () {
              var e = { scroll: t(document).height(), window: t(window).height(), header: t(l).outerHeight(), footer: t(d).outerHeight() },
                i = Math.abs(e.window + t(window).scrollTop() - e.scroll),
                n = t(window).scrollTop(),
                s = !1,
                r = !1;
              t("body").hasClass(u) &&
                ((t("body").hasClass(g) || t("body").hasClass(p) || t("body").hasClass(_) || t("body").hasClass(m) || t("body").hasClass(C)) && "fixed" === t(l).css("position") && (s = !0),
                (t("body").hasClass(v) || t("body").hasClass(y) || t("body").hasClass(b) || t("body").hasClass(D) || t("body").hasClass(E)) && "fixed" === t(d).css("position") && (r = !0),
                0 === n && 0 === i
                  ? (t(o).css("bottom", e.footer), t(o).css("top", e.header), t(o + ", " + o + " " + a).css("height", e.window - (e.header + e.footer)))
                  : i <= e.footer
                  ? !1 === r
                    ? (t(o).css("bottom", e.footer - i), t(o + ", " + o + " " + a).css("height", e.window - (e.footer - i)))
                    : t(o).css("bottom", e.footer)
                  : n <= e.header
                  ? !1 === s
                    ? (t(o).css("top", e.header - n), t(o + ", " + o + " " + a).css("height", e.window - (e.header - n)))
                    : t(o).css("top", e.header)
                  : !1 === s
                  ? (t(o).css("top", 0), t(o + ", " + o + " " + a).css("height", e.window))
                  : t(o).css("top", e.header));
            }),
            (n._fixHeight = function () {
              ...
              if (t("body").hasClass(u)) {
                var s = e - i;
                (t("body").hasClass(v) || t("body").hasClass(y) || t("body").hasClass(b) || t("body").hasClass(D) || t("body").hasClass(E)) && "fixed" === t(d).css("position") && (s = e - i - n),
                  t(o + " " + a).css("height", s),
                  "undefined" != typeof t.fn.overlayScrollbars &&
                    t(o + " " + a).overlayScrollbars({ className: this._config.scrollbarTheme, sizeAutoCapable: !0, scrollbars: { autoHide: this._config.scrollbarAutoHide, clickScrolling: !0 } });
              }
            }),
        ...
        y = (function () {
          ...
          return (
            (i.fixLayoutHeight = function (e) {
              ...
              var s = { window: t(window).height(), header: 0 !== t(n).length ? t(n).outerHeight() : 0, footer: 0 !== t(d).length ? t(d).outerHeight() : 0, sidebar: 0 !== t(o).length ? t(o).height() : 0, control_sidebar: i },
                l = this._max(s);
              l == s.control_sidebar ? t(a).css("min-height", l) : l == s.window ? t(a).css("min-height", l - s.header - s.footer) : t(a).css("min-height", l - s.header),
                t("body").hasClass(g) &&
                  (t(a).css("min-height", l - s.header - s.footer),
                  "undefined" != typeof t.fn.overlayScrollbars && t(o).overlayScrollbars({ className: this._config.scrollbarTheme, sizeAutoCapable: !0, scrollbars: { autoHide: this._config.scrollbarAutoHide, clickScrolling: !0 } }));
            }),
            (i._init = function () {
              var e = this;
              if (
    ...
    n = (function (t) {
          ...
          return (
            ...
            (n.remember = function () {
              this._options.enableRemember &&
                (localStorage.getItem("remember" + i) == r
      ...
      return (
        t(document).on("click", a.TOGGLE_BUTTON, function (e) {
          e.preventDefault();
    ...
    r = (function (t) {
          ...
          return (
            (i.collapse = function () {
              ...
              this._parent.children(a.CARD_BODY + ", " + a.CARD_FOOTER).slideUp(this._settings.animationSpeed, function () {
                ...
                this._parent
                  .find("> " + a.CARD_HEADER + " " + this._settings.collapseTrigger + " ." + this._settings.collapseIcon)
            ...
            (i.expand = function () {
              ...
              this._parent.children(a.CARD_BODY + ", " + a.CARD_FOOTER).slideDown(this._settings.animationSpeed, function () {
                ...
                this._parent
                  .find("> " + a.CARD_HEADER + " " + this._settings.collapseTrigger + " ." + this._settings.expandIcon)
            ...
            (i.minimize = function () {
              this._parent
                ...
                this._parent
                  ...
                  .delay(10)
                  .queue(function () {
                    t(this).removeClass(o.MAXIMIZED), t("html").removeClass(o.MAXIMIZED), t(this).css({ height: "inherit", width: "inherit" }), t(this).hasClass(o.WAS_COLLAPSED) && t(this).removeClass(o.WAS_COLLAPSED), t(this).dequeue();
                  });
            ...
            (e._jQueryInterface = function (i) {
              ...
              n || ((n = new e(t(this), s)), t(this).data("lte.cardwidget", "string" == typeof i ? n : i)),
      ...
      return (
        t(document).on("click", a.DATA_COLLAPSE, function (e) {
            ...
            (i.load = function () {
              this._addOverlay(),
                ...
                t.get(
                  ...
                  function (e) {
                    this._settings.loadInContent && ("" != this._settings.sourceSelector && (e = t(e).find(this._settings.sourceSelector).html()), this._parent.find(this._settings.content).html(e)),
    ...
    d = (function (t) {
      var e = "Dropdown",
        ...
        a = (function () {
          ...
          return (
            (e.prototype.toggleSubmenu = function () {
        ...
        m = (function () {
          ...
          return (
            (i.create = function () {
              ...
              if (
                (null != this._config.icon && i.append(t("<i />").addClass("mr-2").addClass(this._config.icon)),
